...
public class EmailMessageTemplate {
	...
	@Column
	String title; // SQL Type: VARCHAR size:100
	@Column
	String content; // SQL Type: VARCHAR size:5000
	@Column
	...
	@Column
	String fromAddress; // SQL Type: VARCHAR size:50
	@Column
	String senderName; // SQL Type: VARCHAR size:100
	@Column
